...
func (c *Controller) syncHandler(key string) error {
	...
	deploymentName := nfsshare.Spec.DeploymentName
	if deploymentName == "" {
	...
	deployment, err := c.deploymentsLister.Deployments(nfsshare.Namespace).Get(deploymentName)
...
func newDeployment(nfsshare *nfssharev1alpha1.Nfsshare) *appsv1.Deployment {
	...
	return &appsv1.Deployment{
		ObjectMeta: metav1.ObjectMeta{
			Name:      nfsshare.Spec.DeploymentName,
